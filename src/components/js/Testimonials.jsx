...
const sliderData = [
    {
        ...
        review: '"Carlos is a remarkable talent. His ability to grasp complex concepts and to adapt to enterprise class building processes is exemplary. I had the pleasure of working closely with Carlos and find him to be an excellent listener and an excellent study. He has the ability to pick things up quickly and bring them to bear in his work product. I highly recommend Carlos and feel he would be a great addition and a truly valuable asset to any high performance development team."',
    },
    {
        id: 2,
        avatar: Justin,
    ...
    },
    {
        ...
        review: '"Carlos is a very professional and hard working individual. I worked with him when he was a junior developer at BetterNOI. Being new to the technology stack that we used, he with his curious nature learned our ways fast and got up to speed with little to no help. He is very capable of handling projects and tasks that are his responsibility and he will get the job done quickly and with precision. I would highly recommend him for a development position."',
    },
    {
        id: 5,
        avatar: Juan,
        ...
        review: '"I worked next to Carlos and saw him learn and improve very quick. Whatever task was given to him, he would get it done. He has a lot of potential. I have no doubt hes going to do great anywhere he goes!"',
    },
    {
        id: 6,
        avatar: Jeff,
        ...
        review: '"Carlos is a knowledgeable and driven individual. One of the hardest parts of joining an established company with an extensive code base is learning its processes and becoming an asset. Carlos was able to jump in and gain a firm grasp rapidly. I admire his drive to learn and it was refreshing to work with him. Carlos utilized his time wisely and rarely was stationary on an issue without reaching out to other engineers for guidance. Carlos will be an asset where ever he goes and I hope to work with him again in the future."',
    },
];
                ...
                <div className="test-content">
                    ...
                    <Slider {...slideSettings} className="testimonials-wrapper">
                        {sliderData.map((slider) => (
                            <TestimonialSlider key={slider.id} slider={slider} />
                        ))}
                    </Slider>
                </div>
            </div>
